...
<script>
    ...
    if (this.value === 'scholar') {
        ...
        orInputContainer3.style.display = 'block';  
				    ...
				    <select id="scholarship" name="type_of_scholar3" class="w-full px-4 py-2 border rounded-lg focus:ring focus:ring-blue-300 bg-white dark:border-gray-600 dark:text-black">
                                        <option value="" disabled selected>Select your scholarship type</option>
                                        <option value="ttsp">TTSP</option>
                                        <option value="cfsp">CFSP</option>
					<option value="uaqtea">UAQTEA</option>
                ...
                <div>
                                    ...
                                    <select id="qualification4" name="qualification4" required 
					    class="w-full px-4 py-2 border rounded-lg focus:ring focus:ring-blue-300 bg-white dark:border-white-600 dark:text-black">
                                        <option value="" disabled selected>Select your qualification</option>
                                        <option value="FBS NC II">FBS NC II</option>
                                        <option value="CSS NC II">CSS NC II</option>
    ...
    if (this.value === 'scholar') {
        ...
        orInputContainer4.style.display = 'block';  
				    ...
				    <select id="scholarship" name="type_of_scholar4" class="w-full px-4 py-2 border rounded-lg focus:ring focus:ring-blue-300 bg-white dark:border-gray-600 dark:text-black">
                                        <option value="" disabled selected>Select your scholarship type</option>
                                        <option value="ttsp">TTSP</option>
                                        <option value="cfsp">CFSP</option>
					<option value="uaqtea">UAQTEA</option>
...
<div class="mt-4">
    ...
    document.getElementById('qualification3').addEventListener('change', function() {
        ...
        // Update title based on selected qualification
        if (qualification3) {
            titleElement.innerHTML = `<h3>Please add PDF for ${qualification3}</h3>`;
        }
    });
</script>
...
<div class="mt-4">
    ...
    document.getElementById('qualification4').addEventListener('change', function() {
        ...
        // Update title based on selected qualification
        if (qualification4) {
            titleElement.innerHTML = `<h3>Please add PDF for ${qualification4}</h3>`;
        }
    });
</script>
...
<div class="mt-4">
    ...
    <!-- Document Preview -->
    <div id="elttPreviewContainer4" style="display:none; margin-top: 10px; text-align: center;">
...
<div class="mt-4">
    ...
    <!-- Document Preview -->
    <div id="rfftpPreviewContainer4" style="display:none; margin-top: 10px; text-align: center;">
...
<div class="mt-4" class="text-white" style="display: none;" id="orInputContainer4">
    ...
    <!-- Document Preview -->
    <div id="oropfafnsPreviewContainer4" style="display:none; margin-top: 10px; text-align: center;">
...
<div class="mt-4">
    ...
    <!-- Document Preview -->
    <div id="sopcctvrPreviewContainer4" style="display:none; margin-top: 10px; text-align: center;">
...
document.getElementById('next_button').addEventListener('click', function () {
    ...
    if (!assessmentDate || !qualification4 || !noOfPax4 || !trainingStatus4) {
        alert('Please fill all the required fields in Step 4.');
        return;
    }
    ...
    if (trainingStatus4 === 'scholar') {
        const scholarshipType4 = document.getElementById('scholarship4').value;
        if (!scholarshipType4) {
            alert('Please select a scholarship type.');
            return;
        }
